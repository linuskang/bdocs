...
<Callout type="warn" title="Beta Version">
  ...
  You can try the beta features on our [development branch](https://github.com/bubblymaps/bubblymaps/tree/v5).
</Callout>
...
<Callout title="Latest Version">
  ...
  You can download it [here](https://github.com/bubblymaps/bubblymaps/releases/tag/v5.0.2)
</Callout>
